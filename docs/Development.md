# Development and Testing Guide <br/> Pip.Services SQLServer Components for Node.js
...
- Download and install SQLServer database from https://www.sqlserverql.org/download/
